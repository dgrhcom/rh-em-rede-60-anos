...
export const TOP_CARGOS_2026 = [
  { cargo: 'Técnico em Administração (PAEPE)', quantidade: 1430, categoria: 'Administração e RH' },
  { cargo: 'Técnico de Enfermagem (PAEPE)', quantidade: 1322, categoria: 'Saúde' },
  { cargo: 'Professor Associado', quantidade: 818, categoria: 'Educação, Pesquisa e Ciência' },
  { cargo: 'Professor Doutor', quantidade: 563, categoria: 'Educação, Pesquisa e Ciência' },
  { cargo: 'Enfermeiro (PAEPE)', quantidade: 554, categoria: 'Saúde' },
  { cargo: 'Médico (PAEPE)', quantidade: 432, categoria: 'Saúde' },
  { cargo: 'Professor Titular', quantidade: 394, categoria: 'Educação, Pesquisa e Ciência' },
  { cargo: 'Profissional de Administração (PAEPE)', quantidade: 330, categoria: 'Administração e RH' },
  { cargo: 'Analista de Desenv. de Sistemas (PAEPE)', quantidade: 228, categoria: 'Tecnologia da Informação (TI)' },
  { cargo: 'Prof. Magistério Secundário Técnico', quantidade: 181, categoria: 'Educação, Pesquisa e Ciência' },
  { cargo: 'Técnico de Laboratório (PAEPE)', quantidade: 162, categoria: 'Saúde' },
  { cargo: 'Biologista (PAEPE)', quantidade: 132, categoria: 'Saúde' },
  { cargo: 'Prof. Educação Infantil e Fundamental', quantidade: 129, categoria: 'Educação, Pesquisa e Ciência' },
  { cargo: 'Analista de Suporte Computacional', quantidade: 103, categoria: 'Tecnologia da Informação (TI)' },
  { cargo: 'Bibliotecário (PAEPE)', quantidade: 97, categoria: 'Educação, Pesquisa e Ciência' },
  { cargo: 'Pesquisador (PQ)', quantidade: 92, categoria: 'Educação, Pesquisa e Ciência' },
  { cargo: 'Profissional de Pesquisa', quantidade: 79, categoria: 'Educação, Pesquisa e Ciência' },
  { cargo: 'Técnico em Biblioteconomia', quantidade: 72, categoria: 'Educação, Pesquisa e Ciência' },
  { cargo: 'Biólogo (PAEPE)', quantidade: 65, categoria: 'Educação, Pesquisa e Ciência' },
